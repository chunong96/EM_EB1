	...
	{	GPIOG->ODR &= ~0x0004;	// LED2 Off (GPIOG->ODR.2 'L')
        ...
        switch(KEY_Scan()) //스위치의 진동에 의한 채터링Chattering 현상을 방지하기 위한 키스캔 함수
        {
        	case 0xFE00  : 	//SW0   //0b 1111 1110 0000 0000
                        GPIOG->ODR ^= 0x0001; 	//  LED0 (PG0) Toggle //토글은 XOR
                        BEEP();
  	        break;
