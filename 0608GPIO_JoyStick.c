...
int main(void)
{
	...
	while(1)
	{
		...
		{
        		case NAVI_UP : 	// Joystick UP		0x03A0  //PI6 0000 0011 1010 0000 
				if (SW0_Flag==0) {
        		...
        		case NAVI_DOWN:	// Joystick DOWN        0x0360  //PI7 0000 0011 0110 0000 
				if (SW1_Flag==0) {
          		...
          		break;
                        ...
                        case NAVI_RIGHT:	// Joystick RIGHT        0x02E0  //PI8 0000 0010 1110 0000 
				if (SW1_Flag==0) {
					GPIOG->ODR |= 0x0004; // LED1 ON
                 			LCD_DisplayText(2,0,"2.LED2 ON ");
					SW1_Flag = 1;
				}
				else {
					GPIOG->ODR &= ~0x0004; // LED1 OFF
					LCD_DisplayText(2,0,"2.LED2 OFF");
					SW1_Flag = 0;
				}
                              
          		break;
                        
                        case NAVI_LEFT:	// Joystick LEFT       0x01E0  //PI9 0000 0001 1110 0000 
				if (SW1_Flag==0) {
					GPIOG->ODR |= 0x0008; // LED1 ON
                 			LCD_DisplayText(2,0,"3.LED3 ON ");
					SW1_Flag = 1;
				}
				else {
					GPIOG->ODR &= ~0x0008; // LED1 OFF
					LCD_DisplayText(2,0,"3.LED3 OFF");
					SW1_Flag = 0;
				}
                              
          		break;
                        
                case NAVI_PUSH:	//Joystick PUSH       0x03C0  //PI5 0000 0011 1100 0000 
				if (SW1_Flag==0) {
					GPIOG->ODR |= 0x0010; // LED1 ON
                 			LCD_DisplayText(2,0,"4.LED4 ON ");
					SW1_Flag = 1;
				}
				else {
					GPIOG->ODR &= ~0x0010; // LED1 OFF
					LCD_DisplayText(2,0,"4.LED4 OFF");
					SW1_Flag = 0;
				}
...
void DisplayInitScreen(void)
{
	...
	LCD_DisplayText(1,0,"0.LED0 Off");	// subtitle
	LCD_DisplayText(2,0,"1.LED1 Off");	// subtitle
}
